...
router.get('/get_all_books', authentication, plannerBooksController.getAllBooks);
...
router.get('/get_detail_books', authentication, plannerBooksController.getAllDetailPlannerBooks);
